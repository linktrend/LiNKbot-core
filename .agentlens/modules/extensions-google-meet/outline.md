...
## extensions/google-meet/index.create.test.ts (841 lines)

| Line | Kind | Name | Visibility |
| ---- | ---- | ---- | ---------- |
| 57 | fn | setup | (private) |
| 73 | fn | runCreateMeetBrowserScript | (private) |
| 97 | type | BrowserScriptResult | (private) |
| 164 | fn | requireRecord | (private) |
| 171 | fn | mockCalls | (private) |
| 183 | fn | findMockCall | (private) |
| 191 | fn | responsePayload | (private) |
| 197 | fn | responseErrorPayload | (private) |
| 203 | fn | findNodeInvokeParams | (private) |

## extensions/google-meet/index.test.ts (8593 lines)

| Line | Kind | Name | Visibility |
| ---- | ---- | ---- | ---------- |
| 59 | type | GoogleMeetManifestConfigSchema | (private) |
| 66 | fn | createIsolatedTestDir | (private) |
| 72 | type | MeetRealtimeAudioSpawn | (private) |
| 76 | fn | createTestMeetRealtimeAudioTransport | (private) |
| 101 | fn | createEmptyMeetingRealtimeAudioEngineHealth | (private) |
| 117 | fn | createGoogleMeetTestEngineBindings | (private) |
| 137 | type | TestLocalAgentEngineParams | (private) |
| 147 | fn | startTestLocalAgentAudioBridge | (private) |
| 167 | type | TestLocalRealtimeEngineParams | (private) |
| 177 | fn | startTestLocalRealtimeAudioBridge | (private) |
| 197 | type | TestNodeRealtimeEngineParams | (private) |
| 206 | fn | startTestNodeRealtimeAudioBridge | (private) |
| 288 | fn | setup | (private) |
| 329 | fn | resolveGoogleMeetConfigFromTestEnv | (private) |
| 339 | fn | jsonResponse | (private) |
| 346 | fn | requireGoogleMeetManifestConfigSchema | (private) |
| 355 | fn | requireConfigProperty | (private) |
| 366 | fn | isRecord | (private) |
| 370 | type | MockSessionEntry | (private) |
| 376 | fn | createMockSessionRuntime | (private) |
| 409 | fn | requireRecord | (private) |
| 416 | fn | mockCall | (private) |
| 424 | fn | mockCallArg | (private) |
| 428 | fn | expectRespondedOk | (private) |
| 432 | fn | requireRespondPayload | (private) |
| 439 | fn | requireSetupCheck | (private) |
| 449 | type | TwilioSetupCredentials | (private) |
| 455 | fn | getTwilioVoiceCallCredentialsCheck | (private) |
| 497 | fn | requireFetchGuardCall | (private) |
| 507 | fn | requestUrl | (private) |
| 517 | fn | mockLocalMeetBrowserRequest | (private) |
| 578 | fn | createCapturedBrowserRuntime | (private) |
| 592 | fn | captureMeetStatusScript | (private) |
| 656 | fn | captureMeetTranscriptScript | (private) |
| 683 | fn | captureMeetLeaveScript | (private) |
| 716 | fn | stubMeetArtifactsApi | (private) |
| 844 | type | TestBridgeProcess | (private) |
| 856 | fn | installTestBridgeKill | (private) |
| 3202 | fn | mockLocalMeetBrowserRequestWithTabState | (private) |
| 3770 | fn | makeButton | (private) |
| 4265 | fn | makeButton | (private) |
| 4343 | fn | makeRegion | (private) |
| 4436 | fn | readTranscript | (private) |
| 4490 | fn | makeButton | (private) |
| 4591 | fn | makeButton | (private) |
| 6629 | fn | audioBridge | (private) |

## extensions/google-meet/index.ts (1321 lines)

| Line | Kind | Name | Visibility |
| ---- | ---- | ---- | ---------- |
| 354 | fn | asParamRecord | (private) |
| 360 | fn | normalizeTransport | (private) |
| 364 | fn | normalizeMode | (private) |
| 371 | fn | isGoogleMeetTalkBackMode | (private) |
| 375 | fn | resolveMeetingInput | (private) |
| 383 | fn | shouldJoinCreatedMeet | (private) |
| 406 | type | GoogleMeetGatewayToolAction | (private) |
| 419 | fn | googleMeetGatewayMethodForToolAction | (private) |
| 436 | fn | isGoogleMeetAgentToolActionUnsupportedOnHost | (private) |
| 461 | fn | assertGoogleMeetAgentToolActionSupported | (private) |
| 473 | fn | readGatewayErrorDetails | (private) |
| 480 | fn | callGoogleMeetGatewayFromTool | (private) |
| 517 | fn | keepTrustedToolAgentId | (private) |
| 529 | fn | createMeetFromParams | (private) |
| 538 | fn | createAndJoinMeetFromParams | (private) |
| 548 | fn | resolveGoogleMeetTokenFromParams | (private) |
| 562 | fn | wantsCalendarLookup | (private) |
| 566 | fn | resolveMeetingFromParams | (private) |
| 584 | fn | resolveSpaceFromParams | (private) |
| 598 | fn | resolveArtifactQueryFromParams | (private) |
| 629 | fn | exportGoogleMeetBundleFromParams | (private) |
| 722 | fn | ensureRuntime | (private) |
| 737 | fn | formatGatewayError | (private) |
| 740 | fn | sendError | (private) |

## extensions/google-meet/node-host.test.ts (594 lines)

| Line | Kind | Name | Visibility |
| ---- | ---- | ---- | ---------- |
| 6 | type | MockChild | (private) |
