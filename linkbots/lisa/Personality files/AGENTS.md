...
- Coding delegates to Cursor by default. On **weekday nights from 19:00–04:00** Asia/Taipei, use the dedicated local-coder route automatically (the overnight window ends by 04:00 so Ship 05 can run). Carlos can explicitly request local-coder any time. Cursor ACP remains unchanged.
