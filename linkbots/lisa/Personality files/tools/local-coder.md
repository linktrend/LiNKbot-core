...
- **Routing:** local-coder is automatic for coding on weekday nights from 19:00–04:00 Asia/Taipei and whenever Carlos explicitly asks for local-coder/Qwen local coding. Cursor remains the automatic default on weekends.
