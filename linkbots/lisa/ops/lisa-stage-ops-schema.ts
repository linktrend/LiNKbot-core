 ...
 *
 * Consumer boundary: OpenClaw Lisa stage Repair Dispatcher / GitOps /
 * Main Approve durable state. IDE Development remains the external
 * control-plane SoT and is untouched by these tables.
 */
