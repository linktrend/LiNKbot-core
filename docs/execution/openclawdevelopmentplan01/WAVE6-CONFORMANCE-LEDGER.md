...
**Tip proof (local):** `node scripts/run-vitest.mjs test/helpers/link-domain-fakes extensions/linkbrain extensions/linkskills` → **26 files / 185 tests** PASS; `git diff --check` clean
