...
`95e0494c1f332fd33cea12152a07dd404c52bb07` (tree
`dbeea3e695449c1a5e79962d772d1c0716f42fc5`), the exact progressive
validation policy digest, workflow, run `32917935092`, and the complete ten-job
failure contract recorded in the receipt. The original Full CI identity
`c98757b598e753ce0344037a3f0ae6321121f6c6` / tree
`76dd3b81b3db9ffaff614ca3d0561b26a7fb5705` is preserved on the receipt and is
not a new Full acceptance. The six protected CI contexts are
