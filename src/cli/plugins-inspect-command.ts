    ...
    defaultRuntime.log(
      renderTable({
        ...
        columns: [
          ...
          { key: `ltfx.n.9460f16ac9b5171e7f3d.v1`, header: "Capabilities", minWidth: 28, flex: true },
          { key: `ltfx.n.b37ddf1f6e0fac69414c.v1`, header: "Compatibility", minWidth: 24, flex: true },
