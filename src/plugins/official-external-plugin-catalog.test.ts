...
describe("official external plugin catalog", () => {
  ...
  it("maps env-only web-fetch credentials to external plugin owners", () => {
    expect(
      resolveOfficialExternalWebProviderContractPluginIdsForEnv({
        contract: "webFetchProviders",
        env: { FIRECRAWL_API_KEY: `ltfx.n.7e2df43f2f552e00bb5d.v1` },
      }),
    ).toEqual(["firecrawl"]);
    expect(
      resolveOfficialExternalWebProviderContractPluginIdsForEnv({
  ...
  it("maps env-only provider credentials to external installs", () => {
    expect(
      resolveOfficialExternalProviderPluginIdsForEnv({
        ARCEEAI_API_KEY: `ltfx.n.216d3715babe0b498b92.v1`,
        CEREBRAS_API_KEY: `ltfx.n.ecfeb9e4d4f6ddba36a4.v1`,
        CHUTES_OAUTH_TOKEN: `ltfx.n.8bebf3e3e37045a35f27.v1`,
        CLOUDFLARE_AI_GATEWAY_API_KEY: `ltfx.n.90e1104f4605ee00776b.v1`,
        DEEPINFRA_API_KEY: `ltfx.n.7aac61b28eedbcec0b95.v1`,
        DEEPSEEK_API_KEY: `ltfx.n.cb405cc317bb2ae9b3fa.v1`,
        FEATHERLESS_API_KEY: `ltfx.n.d0f919845b1fa2f3015c.v1`,
        GROQ_API_KEY: `ltfx.n.ed4dcf88da9b2ba45741.v1`,
        LONGCAT_API_KEY: `ltfx.n.c475af23df762bfc2480.v1`,
        KILOCODE_API_KEY: `ltfx.n.0fe7df1b85956587b556.v1`,
        KIMICODE_API_KEY: `ltfx.n.c5908972ddb5860c239d.v1`,
        KIMI_API_KEY: `ltfx.n.2dce027b791c783f20fd.v1`,
        MOONSHOT_API_KEY: `ltfx.n.05808b8f23e36eb10195.v1`,
        QIANFAN_API_KEY: `ltfx.n.69d73648a0bcd8037e3b.v1`,
        MODELSTUDIO_API_KEY: `ltfx.n.ee275fb6bb5dca04df52.v1`,
        STEPFUN_API_KEY: `ltfx.n.4f26efa0756b6b91a584.v1`,
        FIREWORKS_API_KEY: `ltfx.n.4a3c225cd7288b2de7c9.v1`,
        TOKENHUB_API_KEY: `ltfx.n.3518fa2ecc186be4a647.v1`,
        TOKENPLAN_API_KEY: `ltfx.n.2d702cf5693e604f7b6d.v1`,
        VENICE_API_KEY: `ltfx.n.c1e96168b72808743658.v1`,
        AI_GATEWAY_API_KEY: `ltfx.n.8cb1c6bc8952bb3def9c.v1`,
        ZAI_API_KEY: "zai-key",
      }),
    ).toEqual([
      "arcee",
